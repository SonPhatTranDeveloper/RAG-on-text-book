...
def main():
    parser = argparse.ArgumentParser(description='Run multiple choice evaluation on RAG systems')
    parser.add_argument('--rag-type', 
    ...
    parser.add_argument('--subject', 
                       choices=['toan', 'ngu_van', 'vat_ly', 'hoa_hoc', 'sinh_hoc', 'dia_ly', 'lich_su'],
                       required=True,
